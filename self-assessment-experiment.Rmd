...
protest_filtered_filename <- "protest_filtered.csv"
protest_filtered_file <- here::here("data", protest_filtered_filename)
...
protest_sheet <- googlesheets4::read_sheet("https://drive.google.com/open?id=1gsf9I_H34ymYvZGGYhzGNk7NoeneJoJl0bAP8NjNRAI")
...
write.csv(protest_sheet_filtered, file = protest_filtered_file)
