...
```{r pretest_geotech_terms_fig, fig.width=14, fig.height=14, dpi=300}
plot(results, type="bar", legend = "", legend.position = "bottom",
     centered=TRUE, text.size=3, 
...
ggsave(here::here("figs", "fig01_geoteach_pretest.png"), width = 14, height = 10, dpi = 300)
...
ggsave(here::here("figs", "fig02_geoteach_postest.png"), width = 14, height = 10, dpi = 300)
...
```{r postest_geotech_perception_fig, fig.width=10, fig.height=6}
...
```{r both_geotech_terms_fig, fig.width=14, fig.height=14, dpi=300}
...
ggsave(here::here("figs", "fig03_geoteach_both.png"), width = 14, height = 10, dpi = 300)
