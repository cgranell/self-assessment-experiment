...
`r n_answered_yes` students (EM Master Geotech) added the self-assessment statement (to the thesis manuscript) and answered the pre-questionnaire. Self-assessment statements are added to the analysis.

`r n_answered_no` students (EM Master Geotech) added the self-assessment statement but _did not_ answered the pre-questionnaire. These two cases are omitted from the analysis.
