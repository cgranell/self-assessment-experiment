...
abstract_sentence <- magick::image_read(here::here("figs", "abstract-selfassessment-example.PNG"))





p_empty <- ggplot2::ggplot() + coord_fixed()
p_abstract <- ggbackground(p_empty, abstract_sentence) 

(p1 + p2 + p3) / (p4 + p_abstract + p5)
