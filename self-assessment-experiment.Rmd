...
```{r fig_likert_terms, fig.width=15, fig.height=14, dpi=300}
...
```{r fig_likert_terms_post, fig.width=15, fig.height=14, dpi=300}
plot(results, type="bar", legend = "", legend.position = "bottom",
     low.color = "goldenrod2", high.color="indianred4") +
...
```{r fig_questions_sect2_post, fig.width=10}
categoryColumns <- c("Are you planning to learn more about \nreproducible research on your own?",
                     "How important are reproducibility practices for \nyour future professional career (academia, industry, government, etc.)?")

colours <- RColorBrewer::brewer.pal(length(categoryColumns), "Set1")

one_to_five_levels <- c("1", "2", "3", "4", "5")
questionsBarplot = function(data, main, colour, levels) {
  barplot(table(data, useNA = "ifany"), 
          main = main,
          xlab = "Level", 
          ylim = c(0,6),
          names.arg = levels,col = colours[colour])
...
questionsBarplot(geotech_postest$`Are you planning to learn more about reproducible research on your own?`,
                main = paste("A:", categoryColumns[1]), colour = 1, c("2", "4", "5"))
questionsBarplot(geotech_postest$`How important are reproducibility practices for your future professional career (academia, industry, government, etc.)?`,
                main = paste("B:", categoryColumns[2]), colour = 2, c("4", "5"))
